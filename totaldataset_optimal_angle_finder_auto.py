...
output_dir = './outputs/'
output_file = os.path.join(output_dir, 'results_auto.xlsx')
...
# === 5. 加载或训练模型 ===
model_dir = 'models/current_prediction_scaled_autogluon'
...
leaderboard.to_excel(os.path.join(output_dir, 'leaderboard.xlsx'))
print(leaderboard)